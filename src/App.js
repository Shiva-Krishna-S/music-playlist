...
class App extends Component {
  ...
  getSearchItems = () => {
    ...
    const filteredPlaylist = playlist.filter(eachItem =>
  ...
  renderPlayListView = () => {
    const filteredPlaylist = this.getSearchItems()
  ...
  render() {
    ...
    const filteredPlaylist = this.getSearchItems()
    const isPlayListEmpty = filteredPlaylist.length === 0
    ...
    return (
      <>
        ...
        <div className="content-container">
          <div className="section-title-and-search-input-container">
            <h1 className="section-title">Songs Playlist</h1>
